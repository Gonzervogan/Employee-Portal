angular.module('MainApp').factory('AuthenticationService', ['$rootScope', '$http', '$cookieStore', function($rootScope, $http, $cookieStore) {
    var service = {};
    service.login = function(username, password, callback) {
        ...
        //Mimicking REST CALL
        var ret = {};
        if (user.username === 'ed.chase' && user.password === 'ed123') {
            ret.success = true;
